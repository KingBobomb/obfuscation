...
class AiAgent:
    ...
    Args:
        base_weights (dict):
            Weights used to guide the AI on what to do during
        its turn start_location (Location):
            The starting location of the AI agent.
        incriminating_items_list (list):
            List of items the AI must find to win the game.
    """
